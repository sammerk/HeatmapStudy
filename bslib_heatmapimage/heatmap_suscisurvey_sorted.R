...
## ordering columns: shiny (sorted heatmap)
##   relocate(any_of(c("Schüler_in", "Richtig pro SuS [%]", "a5", "a14", 
#"a6", "a11", "a15", "a10", 
#"a19", "a16", "a7", "a20", 
#"a17", "a18", "a9", "a13", 
#"a12", "a1", "a4", "a2",
#"a3", "a8")))%>% # ordering colums: sorted heatmap shiny 
#
## ordering columns: soscisurvey (sorted heatmap)
##relocate(any_of(c("Schüler_in", "Richtig pro SuS [%]", "a1", "a18", 
# "a7", "a16", "a8", "a13", 
# "a9", "a20", "a15", "a12", 
# "a6", "a17", "a11", "a10",
# "a14", "a2", "a3", "a4", 
# "a5", "a19")))%>% # ordering colums: sorted heatmap soscisurvey 
# 

data_gt_sorted_heatmap <- # gt object: unordered heatmap
  data_soscisurvey |> 
  ...
  relocate(any_of(c("Schüler_in", "Richtig pro SuS [%]", "a1", "a18", 
   ...
   "a6", "a17", "a11", "a10",
   "a14", "a2", "a3", "a4", 
   "a5", "a19", "Gruppenzuordnung")))%>% # ordering colums: sorted heatmap soscisurvey 
  gt(id = "mygt") |>
...
data_gt_sorted_heatmap |> gtsave("test_gtexport_sorted.png")
