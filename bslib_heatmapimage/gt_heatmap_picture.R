...
data_numbers <- read_xlsx("data/data_numbers only.xlsx") # ggf. Dateipfad anpassen und Überordner mit dazu nehmen
...
data_gt_sorted_heatmap <- # gt object: ordered heatmap
  ...
  ungroup() |> 
  add_row(summarise(data_numbers,
  ...
  relocate(any_of(c("Schüler_in", "Richtig pro SuS [%]", "a5", "a14", 
                    "a6", "a11", "a15", "a10", 
                    "a19", "a16", "a7", "a20", 
                    "a17", "a18", "a9", "a13", 
                    "a12", "a1", "a4", "a2",
                    "a3", "a8")))%>% # ordering colums: sorted heatmap
  gt(id = "mygt") |>
  ...
  cols_label(
    ...
    `a1` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">1. Konjunktiv Formgleichheit', 
    ...
    `a2` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">2. Konjunktiv II bilden a)', 
    ...
    `a3` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">3. Konjunktiv II bilden b)', 
    ...
    `a4` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">4. Konjunktiv II bilden c)', 
    ...
    `a5` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">5. Unterschied Konjunktiv I/II', 
    ...
    `a6` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">6. Konjunktiv erkennen a)', 
    ...
    `a7` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">7. Konjunktiv erkennen b)', 
    ...
    `a8` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">8. Konjunktiv erkennen c)', 
    ...
    `a9` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">9. Konjunktiv erkennen d)', 
    ...
    `a10` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">10. Konjunktiv erkennen e)', 
    ...
    `a11` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">11. Imperativ erkennen a)', 
    ...
    `a12` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">12. Imperativ erkennen b)', 
    ...
    `a13` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">13. Imperativ erkennen c)', 
    ...
    `a14` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">14. Imperativ erkennen d)', 
    ...
    `a15` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">15. Imperativ erkennen e)', 
    ...
    `a16` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">16. Indikativ erkennen a)', 
    ...
    `a17` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">17. Indikativ erkennen b)', 
    ...
    `a18` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">18. Indikativ erkennen c)', 
    ...
    `a19` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">19. Indikativ erkennen d)', 
    ...
    `a20` = gt::html(
      paste('<div class="rotation-wrapper-outer">
                  <div class="rotation-wrapper-inner">20. Indikativ erkennen e)', 
...
server <- function(input, output, session) {
  ...
  output$gt <-  
    render_gt({data_gt_sorted_heatmap}) 
